      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <ScrollReveal direction="left">
          <div class="space-y-12">
            <!-- Email -->
            <div>
              <h3 class="text-xs tracking-widest uppercase text-white/30 font-mono mb-4">t('contact.emailLabel')</h3>
            ...
            <!-- Socials -->
            <div>
              <h3 class="text-xs tracking-widest uppercase text-white/30 font-mono mb-6">t('contact.socialsLabel')</h3>
